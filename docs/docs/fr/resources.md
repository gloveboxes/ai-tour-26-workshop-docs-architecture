...
Cette section doit fournir des ressources utiles pour les participants à l'atelier afin de poursuivre leur apprentissage et d'approfondir les technologies abordées.

## Catégories d'exemples de ressources
...
- Pourquoi c'est pertinent pour le contenu de l'atelier
