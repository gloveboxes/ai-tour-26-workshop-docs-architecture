...
Cette section doit fournir des informations générales sur l'atelier, y compris les technologies utilisées, les avantages commerciaux et l'équipe derrière le contenu.
...
- **Nom de l'auteur** : Brève biographie et domaine d'expertise
- **Nom de l'auteur** : Brève biographie et domaine d'expertise
- **Équipe contributrice** : Informations sur l'organisation ou l'équipe
